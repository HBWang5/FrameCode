...
public class AppUtils {
    ...
    public static boolean isMainProcess() {
        ActivityManager am = (ActivityManager) ApiApplication.getApplication().getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> processInfos = am.getRunningAppProcesses();
        String mainProcessName = ApiApplication.getApplication().getPackageName();
    ...
    public static String getVersion() {
        try {
            PackageManager manager = ApiApplication.getApplication().getPackageManager();
            PackageInfo info = manager.getPackageInfo(ApiApplication.getApplication().getPackageName(), 0);
