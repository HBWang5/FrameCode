...
/**
 * ----------Dragon be here!----------/
 * Created by HBWang on 2019/9/6-14:03
 */
public class LongClickUtils {
     ...
     */
    public static void setLongClick(final Handler handler, final View longClickView, final long delayMillis, final ViewLongClick longClickListener) {
