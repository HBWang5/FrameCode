package com.iqb.api.net.http.converter;
 ...
 */
public class IQBConverterFactory extends Converter.Factory{
    private final Gson gson;

    public static IQBConverterFactory create() {
        return create(new Gson());
    }

    public static IQBConverterFactory create(Gson gson) {
        return new IQBConverterFactory(gson);
    }

    private IQBConverterFactory(Gson gson) {
