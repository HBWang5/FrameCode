...
import com.iqb.api.permission.manager.impl.PermissionManagerImpl;
...
public class PermissionHelper implements IPermissionHelper {
    ...
    @Override
    public boolean jurisdictionDetection(Context context,String... Permission) {
        return mIPermissionManager.jurisdictionDetection(context,Permission);
    }
}
