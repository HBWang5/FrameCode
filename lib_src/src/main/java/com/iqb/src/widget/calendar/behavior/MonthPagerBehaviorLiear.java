...
public class MonthPagerBehaviorLiear extends CoordinatorLayout.Behavior<MonthPager> {
    private int top = 0;
                ...
                if (isVerticalScroll) {
                    ...
                    if (lastTop < child.getViewHeight() / 2 + child.getCellHeight() / 2) {
                        ...
                        if (ev.getY() - downY + child.getCellHeight() >= child.getViewHeight()) {
                            ...
                            Utils.scrollTo(parent, (LinearLayout) parent.getChildAt(1), child.getViewHeight(), 10);
                        ...
                        if (ev.getY() - downY + child.getViewHeight() <= child.getCellHeight()) {
                            ...
                            Utils.scrollTo(parent, (LinearLayout) parent.getChildAt(1), child.getCellHeight(), 10);
                            isVerticalScroll = false;
                        } else {
                            //正常上滑
                ...
                if (isVerticalScroll) {
                    ...
                    if (calendarViewAdapter != null) {
                        if (directionUpa) {
                            ...
                            Utils.scrollTo(parent, (LinearLayout) parent.getChildAt(1), child.getCellHeight(), 300);
                        } else {
                            Utils.setScrollToBottom(false);
                            calendarViewAdapter.switchToMonth();
                            Utils.scrollTo(parent, (LinearLayout) parent.getChildAt(1), child.getViewHeight(), 300);
                        }
                    }
