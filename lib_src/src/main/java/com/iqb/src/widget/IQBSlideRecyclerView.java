...
public class IQBSlideRecyclerView extends RecyclerView {
    ...
    public IQBSlideRecyclerView(Context context) {
        this(context, null);
    }

    public IQBSlideRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IQBSlideRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
