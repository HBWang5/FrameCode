package com.iqb.src.widget.calendar.component;
...
import com.iqb.src.widget.calendar.interf.OnAdapterSelectListener;
...
public class CalendarViewAdapter extends PagerAdapter {
    ...
    static void saveSelectedDate(CalendarDate calendarDate) {
        date = calendarDate;
    }
    ...
    private void cancelOtherSelectState() {
    ...
    private void invalidateCurrentCalendar() {
        for (int i = 0; i < calendars.size(); i++) {
            Calendar calendar = calendars.get(i);
            calendar.update();
