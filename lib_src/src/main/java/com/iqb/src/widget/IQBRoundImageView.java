...
public class IQBRoundImageView extends ImageView {
    ...
    public IQBRoundImageView(Context context) {
        this(context, null);
    }

    public IQBRoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IQBRoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
