...
public interface IQBVideoControllerContract {
    abstract class IQBVideoControllerRelativeView<P extends IQVideoControllerContractPresenter> extends IBaseContract.BaseRelativeLayoutLiveView<P> implements IBaseIQBController {
    ...
    abstract class IQVideoControllerContractPresenter<V extends IQBVideoControllerRelativeView> extends IBaseContract.BaseLivePresenter<V> {
    }
